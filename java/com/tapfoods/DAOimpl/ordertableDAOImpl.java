...
public class ordertableDAOImpl implements ordertableDAO {
		    ...
		    private static final String SELECT_ORDERS_BY_USER = "SELECT * FROM ordertable WHERE userId = ?";
			...
			@Override
			 public List<ordertable> getOrdersByUserId(int userId) {
			        ...
			        try (PreparedStatement statement = con.prepareStatement(SELECT_ORDERS_BY_USER)) {
